...
def train_one_epoch(G: AEI_Net, 
    ...
    if epoch == args.start_epoch:
        ...
        dataloader_iter = itertools.islice(dataloader, start_batch, None)
...
if __name__ == "__main__":
    ...
    # wandbのエンティティ（ログイン名）
    parser.add_argument('--use_resume', default='None', type=str, help='Use wandb to track your experiments or not')
    # runを途中から再開する場合にTrue
